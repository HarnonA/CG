 ...
 * 2 Saporra ta uma bosta
 * 3 tirar translate e mudar por coordenada
 * 4 utilizar planos
 */
...
void escada(double x, double y, double z){
...
//============================================
	...
	glRotatef(90, 1, 0, 0);
	glTranslatef(0, 1, -2);
	plano(0, 0, 0, 1.25, 0, 2); //esq
	glTranslatef(1.25, 0, 0);
	plano(0, 0, 0, 0.5, 0, 1.5); //cent
